...
class TestEmailReputationAPI(APIBaseTest):
    def setUp(self):
        super().setUp()
        # The AWS tenant lookup is cached per team and the team persists across this class's
        # tests — clear it so one test's mocked AWS state can't leak into the next.
        cache.clear()
